...
(*uct_scopy_ep_tx_func_t)(uct_ep_h tl_ep, uct_iov_t *iov, size_t iov_cnt,
...
typedef struct uct_scopy_tx {
    ...
    size_t                          total_length;       /* The total length of the user's payload
                                                         * to be transmitted */
    size_t                          consumed_length;    /* The current handled length */
    ...
    ucs_list_link_t                 flush_comp_list;    /* The list of the UCT EP/IFACE flush completions */
...
typedef struct uct_scopy_comp {
    ucs_list_link_t                 list_elem;           /* The element of the TX `flush_comp_list` */
    uct_completion_t                *comp;               /* The pointer to UCT EP/IFACE flush completion */
} uct_scopy_comp_t;
