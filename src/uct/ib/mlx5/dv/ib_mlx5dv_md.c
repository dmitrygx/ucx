...
static ucs_status_t
uct_ib_mlx5_devx_reg_exported_key_old(uct_ib_md_t *ib_md, void *address,
                                      ...
                                      uct_ib_mem_t *ib_memh)
{
    ...
    memh->type       = UCT_IB_MLX5_MEM_EXPORTED;
    status           = UCS_OK;
...
static ucs_status_t
uct_ib_mlx5_devx_import_exported_key_old(uct_ib_md_t *ib_md,
...
static ucs_status_t
uct_ib_mlx5_devx_reg_exported_key_alias(uct_ib_md_t *ib_md, uint64_t flags,
                                        void *address, size_t length,
...
static ucs_status_t
uct_ib_mlx5_devx_import_exported_key_alias(uct_ib_md_t *ib_md,
                                           uint64_t flags,
                                           uint32_t target_gvmi_id,
                                           uint32_t target_mkey,
                                           uct_ib_mem_t *ib_memh)
...
static ucs_status_t
uct_ib_mlx5_devx_reg_exported_key(uct_ib_md_t *ib_md, uint64_t flags,
                                  void *address, size_t length,
                                  uint32_t allowed_gvmi_id,
                                  uct_ib_mem_t *ib_memh)
{
    ...
    return (md->flags & UCT_IB_MLX5_MD_FLAG_CROSS_GVMI_ALIAS) ?
                   uct_ib_mlx5_devx_reg_exported_key_alias(ib_md, flags,
                                                           address, length,
                                                           allowed_gvmi_id,
                                                           ib_memh) :
                   uct_ib_mlx5_devx_reg_exported_key_old(ib_md, address,
                                                         length,
                                                         allowed_gvmi_id,
                                                         ib_memh);
}
                                     ...
                                     uct_ib_mem_t *ib_memh)
{
    ...
    return (md->flags & UCT_IB_MLX5_MD_FLAG_CROSS_GVMI_ALIAS) ?
                   uct_ib_mlx5_devx_import_exported_key_alias(ib_md, flags,
                                                              target_gvmi_id,
                                                              target_mkey,
                                                              ib_memh) :
                   uct_ib_mlx5_devx_import_exported_key_old(ib_md,
                                                            target_gvmi_id,
                                                            target_mkey,
                                                            ib_memh);
}
