                                          ...
                                          uct_ib_mr_type_t mr_type)
{
    ...
    if (ib_memh->flags & UCT_IB_MEM_FLAG_REGISTERED) {
        return uct_ib_dereg_mr(memh->mrs[mr_type].super.ib);
    }

    ucs_assertv_always((ib_memh->flags & UCT_IB_MEM_FLAG_EXPORTED) ||
                       (ib_memh->flags & UCT_IB_MEM_FLAG_IMPORTED),
                       "memh %p: memh->flags 0x%" PRIx32, ib_memh,
                       ib_memh->flags);
    ucs_assertv_always(mr_type == UCT_IB_MR_DEFAULT, "mr_type %u", mr_type);
    ...
    if (ib_memh->flags & UCT_IB_MEM_FLAG_EXPORTED) {
                                  ...
                                  uct_ib_mem_t *ib_memh)
{
    ...
    UCT_IB_MLX5DV_SET(allow_other_vhca_access_in, ein,
                      object_id_to_be_accessed, memh->super.lkey >> 8);
