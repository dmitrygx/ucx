...
/* Which iface event flahs would be packed in the address */
enum {
    UCP_ADDRESS_EVENT_FLAGS =
         UCP_WORKER_UCT_RECV_EVENT_CAP_FLAGS
};
...
struct ucp_address_iface_attr {
    ...
    uint64_t                    event_flags;  /* Interface capability flags */
