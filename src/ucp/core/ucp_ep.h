...
/**
 * @brief Purge requests scheduled on a given UCP endpoint:
 * - protocol requests which are waiting for completions/acknowledgments and not
 *   posted to UCT
 * - flush requests.
 *
 ...
 * @param [in]     purge_flush_reqs Whether should purge flush requests or not.
 */
