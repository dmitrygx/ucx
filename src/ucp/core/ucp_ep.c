                                 ...
                                 const ucp_ep_params_t *params, ucp_ep_h *ep_p)
{
     ...
     * in ep_match.
     */
    conn_sn = ucs_ep_match_get_next_sn(&worker->ep_match_ctx,
                                        remote_address.uuid);
    ep      = ucp_worker_ep_match_retrieve_unexp(worker, remote_address.uuid,
                                                 conn_sn ^
    ...
    ucp_ep_ext_gen(ep)->ep_match.conn_sn = conn_sn;
    ...
    if ((remote_address.uuid == worker->uuid) &&
        ...
        ucp_worker_ep_match_insert_exp(worker, ep, remote_address.uuid);
    }
