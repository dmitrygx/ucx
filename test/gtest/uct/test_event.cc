...
public:
    void init() {
        ...
        m_async_event_ctx.wakeup_fd.fd = -1;
...
uct_test::async_event_ctx test_uct_event::m_async_event_ctx;
...
void test_uct_event::test_recv_am(unsigned arm_flags, unsigned send_flags)
{
    ...
    EXPECT_FALSE(m_async_event_ctx.check_event(*m_e2, 0));
    ...
    EXPECT_TRUE(m_async_event_ctx.check_event(*m_e2,
                                              1000 *
